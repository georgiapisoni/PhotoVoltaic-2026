...
// Only CH1, CH3 and CH4 short-circuit MOSFETs are connected for this test.
const uint8_t SHORT_GATE_PINS[3]        = {5, 3, 2}; // CH1, CH3, CH4
...
void setShortCircuit(bool enabled)
{
  ...
  Serial.println(enabled ? F("CH1/CH3/CH4 short circuits ON")
                         : F("CH1/CH3/CH4 short circuits OFF"));
  Serial.flush();
}
...
void setup(){
  ...
  Serial.println(F("Only CH1/CH3/CH4 short MOSFETs configured on D5/D3/D2"));
