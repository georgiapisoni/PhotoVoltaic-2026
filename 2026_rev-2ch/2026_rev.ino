...
//setting pins
const int chipSelect = 10;        //sd card reader -> CS[D10]
const int LDR_PIN = A0;           //light sensor -> A0=D14
//SD
...
float raw1, raw2;
float multiplier = 0.125;        //ADS1115 conversion factor mV/bit for GAIN_ONE
float R1 = 220;                 //load resistance ch1
float R2 = 220;                 //load resistance ch2
